    ...
    <div class="container mt-3">
        ...
        <form action="/action_page.php">
            <div class="form-group">
                <label for="code-number">Verification Code</label>
                <input type="text" id="code-number" name="code-number" class="form-control">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label for="pwd"> Reconfirm Password:</label>
                <input type="password" class="form-control" id="pwd" placeholder="Enter new password to Reconfirm" name="pswd">
            </div>
